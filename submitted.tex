\documentclass[modern,preprint]{aastex7}
...
\def \UTINAM {Université Marie et Louis Pasteur, CNRS, Institut UTINAM (UMR 6213), OSU Theta F-25000 Besan\c con, France}
...
\affiliation{\UVAstro}
\affiliation{\UBC}
\email[shohw]{JJ.Kavelaars@nrc-cnrc.gc.ca}

\author[0000-0003-0854-745X]{Marc W. Buie}
\affiliation{\SwRI}
\email{buie@boulder.swri.edu}
...
\affiliation{\Aerotek}
\affiliation{\Rubin}
\email{ljones.uw@gmail.com}

\author[0000-0003-0407-2266]{Jean-Marc Petit}
\affiliation{\UTINAM}
\email{petit@obs-besancon.fr}
...
\affiliation{\JHUAPL}
\email{Pontus.Brandt@jhuapl.edu}

\author[0000-0002-3672-0603]{Joel W. Parker}
\affiliation{\SwRI}
\email{joel@boulder.swri.edu}
